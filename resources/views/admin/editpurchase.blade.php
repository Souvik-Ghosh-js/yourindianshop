...
<title>Your Indian Shop Edit warehouse</title>
    ...
    <div class="page-header">
        ...
        <div class="card">
            ...
            <div class="col-lg-6 col-sm-6 col-12">
                <div class="form-group">
            <a href="javascript:void(0);" class="btn btn-submit m-3">Add Warehouse</a>
            </div>
        </div>
            </div>
            </div>
...
<div class="card">
    ...
    <div class="col-lg-6 col-sm-6 col-12">
        <div class="form-group">
    <a href="javascript:void(0);" class="btn btn-submit m-3">Reject Manager</a>
    </div>
</div>
    </div>
    </div>
    ...
    <div class="page-header">
        ...
        <div class="card">
            ...
            <div class="col-lg-6 col-sm-6 col-12">
                <div class="form-group">
            <a href="javascript:void(0);" class="btn btn-submit m-3">Add Manager</a>
            </div>
        </div>
            </div>
            </div>
