...
<script>
    ...
    // Set timeout to show the popup message after 2 minutes (120000 milliseconds)
    setTimeout(showPopupMessage, 12000); // 2 minutes = 120000 milliseconds
</script>
                    ...
                    <div class="row">
                        ...
                        <div class="row d-flex align-items-center justify-content-center">
                            <div class="card col-lg-3 col-11">
                                ...
                                <a href="/user-add-product" class=".custom-btn">Learn More <i class="bi-arrow-right ms-2"></i></a>
                            </div>
                                <div class="card col-lg-3 col-11">
                                ...
                                <div class="card col-lg-3 col-11">
                                    ...
                                    <a href="/pricing" class=".custom-btn">Learn More <i class="bi-arrow-right ms-2"></i></a>
                                </div>
                                <div class="card col-lg-3 col-11">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="px-5 py-5 py-lg-0">
                                ...
                                <a href="/shipping" class="custom-btn">
                                    Explore Now
